...
interface TemplateReopenSiteProps {
  startDate: string;
  fileNumber: string;
...
const TemplateReopenSite = (props: TemplateReopenSiteProps) => {
  return (
    <Html>
      <Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Heading style={h1}>REOPEN SITE</Heading>
          <Text style={heroText}>
            Please reopen the file for the following site at your convenience.
          </Text>
          <Row>
...
export default TemplateReopenSite;
